...
*   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Newman Garage.
...
*   **Website** refers to Newman Garage, accessible from{" "} [https://newman-garage.astralfrontier.org/](https://newman-garage.astralfrontier.org/)
...
*   By email: newman-garage@astralfrontier.org