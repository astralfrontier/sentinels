    ...
    <>
      <DefaultLayout>
        <div className="content">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Newman Garage.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Newman Garage, accessible
                from{" "}
                <a
                  href="https://newman-garage.astralfrontier.org/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://newman-garage.astralfrontier.org/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: newman-garage@astralfrontier.org</li>
          </ul>
        </div>
      </DefaultLayout>
    </>
